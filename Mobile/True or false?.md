# Challenge: True or false? (Cloud-1)
True or false, we can log in as admin easily.
## Summary:
This application contains client-side checks in order for a user to access admin functionality. Players can easily bypass this via modifying the Smali code contained in the APK file.
